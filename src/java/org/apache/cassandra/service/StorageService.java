...
import imc.disxmldb.cassandra.verbhandler.XPathQueryVerbHandler;
...
public class StorageService implements IEndpointStateChangeSubscriber, StorageServiceMBean
{
    ...
    {{
        ...
        put(Verb.XML_XQUERY, Stage.XML_QUERY);
        put(Verb.XML_READ_NODE, Stage.XML_READ_NODE);
    }};
    ...
    public StorageService()
    {
        ...
        MessagingService.instance().registerVerbHandlers(Verb.XML_XQUERY, new XPathQueryVerbHandler());
        MessagingService.instance().registerVerbHandlers(Verb.XML_READ_NODE, new XMLReadNodeVerbHandler());
