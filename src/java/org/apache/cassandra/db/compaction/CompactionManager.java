            ...
            try
            {
                while (scanner.hasNext())
                {
                    ...
                    else
                    {
                        ...
                        if (!indexedColumns.isEmpty() || isCommutative || cfs.isXMLDomCf())
                        {
                            ...
                            while (row.hasNext())
                            {
                                ...
                                {
                                	if (allColumn == null)
                                		allColumn = new ArrayList<IColumn>();
                            ...
                            if (indexedColumnsInRow != null && !indexedColumnsInRow.isEmpty())
                                cfs.indexManager.deleteFromIndexes(row.getKey(), indexedColumnsInRow, allColumn);
                        }
                    }
                }
                if (writer != null)
