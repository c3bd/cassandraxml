                ...
                while (!reader.isEOF())
                {
                    ...
                    Runnable runnable = new WrappedRunnable()
                    {
                        public void runMayThrow() throws IOException
                        {
                            ...
                            {
                            	/*
                            	 * a bug modified by xiafan
                            	 * when recovering from commitlog, there are some mutations with no columnfamily.
                            	 * why?
                            	 */
                                if (columnFamily == null || Schema.instance.getCF(columnFamily.id()) == null)
