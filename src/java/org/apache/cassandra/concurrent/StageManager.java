...
public class StageManager
{
    ...
    static
    {
    	stages.put(Stage.XML_READ_NODE, multiThreadedConfigurableStage(Stage.XML_READ_NODE, Runtime.getRuntime().availableProcessors()));
    	//stages.put(Stage.XML_NODE_STORE, multiThreadedConfigurableStage(Stage.XML_NODE_STORE, getConcurrentWriters()));
    	stages.put(Stage.XML_QUERY, multiThreadedConfigurableStage(Stage.XML_QUERY, Runtime.getRuntime().availableProcessors() * 3));
