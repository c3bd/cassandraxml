...
public final class CFMetaData
{
    ...
    public static CFMetaData newSystemMetadata(String cfName, int cfId, String comment, AbstractType comparator, AbstractType subcc)
    {
    ...
    /**
     * create metadata for xml catalog
     * @param cfName
     * @param cfId
     * @param comment
     * @param keyValidator
     ...
     * @return
     */
	 public static CFMetaData newXMLSystemMetadata(String cfName, int cfId, String comment, AbstractType keyValidator, AbstractType comparator, AbstractType subcc)
	 {
	        ColumnFamilyType type = subcc == null ? ColumnFamilyType.Standard : ColumnFamilyType.Super;
	        CFMetaData newCFMD = new CFMetaData(SysConfig.SYSCATALOG, cfName, type, comparator,  subcc, cfId);
	 ...
	 public static CFMetaData newXMLCollectionMetaData(String cfName, int cfId, String comment)
	 {
	        CFMetaData rootColCf = new CFMetaData(SysConfig.DEFAULT_KEYSPACE,
	    			cfName, ColumnFamilyType.Super,
	    			Int32Type.instance, UTF8Type.instance, cfId).keyCacheSize(SysConfig.COLCF_KEYCACHE);
	    	
	        return 	rootColCf.keyCacheSavePeriod(SysConfig.COLCF_KEY_CACHE_SAVE_PERIOD)
